...
(function (I, d, B) {
  ...
  function D(f, q) {
    q = q || {};d.forEach(q, function (d, h) {
      delete q[h];
    });for (var h in f) !f.hasOwnProperty(h) || "$" === h.charAt(0) && "$" === h.charAt(1) || (q[h] = f[h]);return q;
  }var x = d.$$minErr("$resource"),
      ...
      function u(d, g) {
        ...
        function c(b, k) {
          var c = {};k = s({}, g, k);r(k, function (a, k) {
            v(a) && (a = a());var d;if (a && a.charAt && "@" == a.charAt(0)) {
              d = b;var e = a.substr(1);if (null == e || "" === e || "hasOwnProperty" === e || !C.test("." + e)) throw x("badmember", e);for (var e = e.split("."), n = 0, g = e.length; n < g && d !== B; n++) {
          ...
          D(b || {}, this);
        }var G = new u(y, m);l = s({}, f.defaults.actions, l);e.prototype.toJSON = function () {
          ...
          var g = /^(POST|PUT|PATCH)$/i.test(b.method);e[k] = function (a, z, m, y) {
            var n = {},
                ...
                v(a) ? l = a : g ? f = a : n = a;break;case 0:
                break;default:
                throw x("badargs", arguments.length);}var u = this instanceof e,
                p = u ? f : b.isArray ? [] : new e(f),
                t = {},
                w = b.interceptor && b.interceptor.response || F,
                C = b.interceptor && b.interceptor.responseError || B;r(b, function (b, a) {
              "params" != a && "isArray" != a && "interceptor" != a && (t[a] = H(b));
            });g && (t.data = f);G.setUrlParams(t, s({}, c(f, b.params || {}), n), b.url);n = q(t).then(function (a) {
              var c = a.data,
                  g = p.$promise;if (c) {
                if (d.isArray(c) !== !!b.isArray) throw x("badcfg", k, b.isArray ? "array" : "object", d.isArray(c) ? "array" : "object", t.method, t.url);b.isArray ? (p.length = 0, r(c, function (a) {
                  "object" === typeof a ? p.push(new e(a)) : p.push(a);
                })) : (D(c, p), p.$promise = g);
              }p.$resolved = !0;a.resource = p;return a;
            }, function (a) {
              p.$resolved = !0;(A || E)(a);return h.reject(a);
            });n = n.then(function (a) {
              var b = w(a);(l || E)(b, a.headers);return b;
            }, C);return u ? n : (p.$promise = n, p.$resolved = !1, p);
          };e.prototype["$" + k] = function (a, b, c) {
            v(a) && (c = b, b = a, a = {});a = e[k].call(this, a, this, b, c);return a.$promise || a;
          };
        });e.bind = function (b) {
          return w(y, s({}, g, b), l);
        };return e;
          ...
          s = d.extend,
          H = d.copy,
          v = d.isFunction;u.prototype = { setUrlParams: function (f, g, l) {
          var m = this,
              c = l || m.template,
              h,
              e,
              q = m.urlParams = {};r(c.split(/\W/), function (b) {
            if ("hasOwnProperty" === b) throw x("badname");!/^\d+$/.test(b) && b && new RegExp("(^|[^\\\\]):" + b + "(\\W|$)").test(c) && (q[b] = !0);
